...
df = pd.read_csv("data/Social_Network_Ads_outlier_removed.csv", index_col=0, encoding="utf-8")
...
df_standard_scaled.to_csv('data/Social_Network_Ads_standard_Scaled.csv')
...
df_minmax_scaled.to_csv('data/Social_Network_Ads_minmax_Scaled.csv')
# 5. 스케일링 결과 시각화
